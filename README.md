...
To ensure compliance with FTC(US), GDPR(UK/EU), and LGPD(BR) All personal details do not reflect actual living people. the data used is intended to impersonate a dataset containing real data to be able to do these projects. All generated data will be provided in a "data_source" folder in the project's repository.
